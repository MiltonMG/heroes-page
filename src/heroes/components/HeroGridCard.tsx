...
export const HeroGridCard = ({ hero }: Props) => {
  ...
  const handleClick = () => {
    setShowAll(!showAll); // alterna entre mostrar y ocultar
  };
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-1">
            ...
            {
              hero.powers.length > 3 && !showAll && (
                <Badge variant="outline" className="text-xs bg-blue-200 cursor-pointer" onClick={handleClick}>
